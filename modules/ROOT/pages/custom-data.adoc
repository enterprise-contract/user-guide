...
link:https://hacbs-contract.github.io/ecc/main/reference.html#k8s-api-github-com-hacbs-contract-enterprise-contract-controller-api-v1alpha1-enterprisecontractpolicy[EnterpriseContractPolicy]
